...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"[INFO] Successfull Connect to Database...")
    except:
        print(f"[INFO] Error Connect to Database...")

    #connect kafka server
    try:
        consumer = KafkaConsumer("digitalskola", bootstrap_servers='localhost')
        print(f"[INFO] Successfull Connect to Kafka Server...")
    except:
        print(f"[INFO] Error Connect to Kafka Server...")
